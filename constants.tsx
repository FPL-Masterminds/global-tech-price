...
export const PRODUCT_PRICES: { [productId: string]: { [countryCode: string]: string } } = {
  // M5 Models (US, CA, GB, CZ, MX, TH, HK, JP, MY, SG, VN, TW, AE, AU, NZ, KR, IN, PL, LU, CN, PH, DE, AT, FR, ES, NL, IT, PT, IE, DK, SE, NO)
  'mbp14-m5-16-512': { 'US': 'USD 1,599', 'CA': 'CAD 2,099', 'GB': 'GBP 1,599', 'CZ': 'CZK 45,990', 'MX': 'MXN 37,999', 'TH': 'THB 54,900', 'HK': 'HKD 12,999', 'JP': 'JPY 248,800', 'MY': 'MYR 6,999', 'SG': 'SGD 2,199', 'VN': 'VND 41999000', 'TW': 'TWD 52900', 'AE': 'AED 6,899', 'AU': 'AUD 2,499', 'NZ': 'NZD 2,999', 'KR': 'KRW 2390000', 'IN': 'INR 169,900', 'PL': 'PLN 7,999', 'LU': 'EUR 1,768.54', 'CN': 'CNY 12,999', 'PH': 'PHP 99,990', 'DE': 'EUR 1,799.00', 'AT': 'EUR 1,799.00', 'FR': 'EUR 1,799.00', 'ES': 'EUR 1,599.00', 'NL': 'EUR 1,849.00', 'IT': 'EUR 1,849.00', 'PT': 'EUR 1,849.00', 'IE': 'EUR 1,849.00', 'DK': 'DKK 13,999.00', 'SE': 'SEK 18,995.00', 'NO': 'NOK 21,990.00' },
...
export function getAppleStoreUrl(productId: string, countryCode: string): string | null {
  // Czech Republic, Germany, Austria, France, Spain, Netherlands, Mexico, Thailand, Taiwan, Vietnam, Poland, Luxembourg, Japan, South Korea, China, Denmark, and Sweden use localized slugs; all others use English
